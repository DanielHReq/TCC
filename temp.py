...
#-- 1. Load the cascades
if not face_cascade.load('/home/pi/opencv/data/haarcascades/haarcascade_frontalface_alt.xml'):
    print('--(!)Error loading face cascade')
    exit(0)
if not eyes_cascade.load('/home/pi/opencv/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml'):
