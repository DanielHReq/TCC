...
class CameraApp(App):
    ...
    def build(self):
        ...
        buttonVermelho=  Button(text='Filtra Vermelho', size_hint=(0.5,0.1))     #criamos o botao que seleciona a vermelho
        ...
        self.capture.set(cv2.cv.CV_CAP_PROP_FRAME_HEIGHT,1024)
